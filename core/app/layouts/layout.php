    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="./" class="logo">
          ...
          <span class="logo-mini"><b>N</b>POS</span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>ENE</b>POS</span>
        </a>
              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="">
                      ...
                      <a href="/EnePos/" target="" class="">Home</a>
                      <!--<a href="" target="_blank" class="">Home</a>-->
                      <a href="/EnePos/?view=users" target="" class="">Ver usuarios</a>
