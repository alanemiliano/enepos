  ...
  <div class="col-lg-3 col-xs-6">
    ...
    <div class="small-box bg-aqua">
      <div class="inner">
        ...
        <p style="text-align: center;"><span class="fa fa-cubes fa-3x"></span></p>
      </div>
      <div class="icon">
  ...
  <div class="col-lg-3 col-xs-6">
    ...
    <div class="small-box bg-purple">
      <div class="inner">
        ...
        <p style="text-align: center;"><span class="fa fa-male fa-3x" aria-hidden="true"></span></p>
      </div>
      <div class="icon">
  ...
  <div class="col-lg-3 col-xs-6">
    ...
    <div class="small-box bg-yellow">
      <div class="inner">
        ...
        <p style="text-align: center;"><span class="fa fa-users fa-3x"></span></p>
      </div>
      <div class="icon">
  ...
  <div class="col-lg-3 col-xs-6">
    ...
    <div class="small-box bg-red">
      <div class="inner">
        ...
        <p style="text-align: center;"><span class="fa fa-bars fa-3x"></span></p>
      </div>
      <div class="icon">
