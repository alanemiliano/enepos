...
<br><table class="table table-bordered table-hover">
	...
	<tr>
		...
		<td style="width:70px;">
		<a href="index.php?view=editproduct&id=<?php echo $product->id; ?>" class="btn btn-xs btn-warning"><span class="glyphicon glyphicon-pencil"></span></a>


		<a href="index.php?view=delproduct&id=<?php echo $product->id; ?>" class="btn btn-xs btn-danger"><span class="fa fa-trash"></span></a>
		</td>
	</tr>
	<?php endforeach;?>
</table>
